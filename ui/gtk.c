...
/*
 * If available, return the refresh rate of the monitor in mHz,
 * else return 0 (the default refresh rate).
 */
int gd_monitor_refresh_rate(GtkWidget *widget)
{
    ...
    if (win) {
        ...
        return gdk_monitor_get_refresh_rate(monitor); /* [mHz] */
    }
#endif
    return 0;
}
...
static gboolean gd_draw_event(GtkWidget *widget, cairo_t *cr, void *opaque)
{
    ...
    refresh_rate = gd_monitor_refresh_rate(vc->window ? vc->window : s->window);
    if (refresh_rate) {
